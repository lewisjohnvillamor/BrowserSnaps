...
| --- | --- | --- |
| Chromium | `dist/extension` | `dist/BrowserSnaps-v1.9.0-chromium.zip` |
| Firefox | `dist/firefox-extension` | `dist/BrowserSnaps-v1.9.0-firefox.zip` |
| Safari | `dist/safari-extension` | `dist/BrowserSnaps-v1.9.0-safari-source.zip` |
...
- [ ] Enabling it reloads each page and produces a 0-100 score with a metric breakdown.
- [ ] Scores are lower than an unthrottled run, confirming throttling was applied.
- [ ] Firefox and Safari report a partial score and name Speed Index as unmeasured.
- [ ] Throttling is cleared after the run: a normal capture is not slowed afterwards.
- [ ] Technology detection names the correct framework or CMS on a known site.
- [ ] Detection chips show their evidence on hover.
- [ ] A site with a strict CSP still reports non-global technologies and says globals were blocked.
...
| --- | --- | --- | --- | --- | --- |
| Chrome | — | — | — | Pending v1.9.0 retest | v1.4.1 current-tab capture was confirmed working |
| Edge | — | — | — | Pending | |
| Brave | — | — | — | Pending | |
| Opera | — | — | — | Pending | |
