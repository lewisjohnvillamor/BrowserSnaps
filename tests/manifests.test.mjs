...
test("all browser manifests use the release version", () => {
  assert.equal(chromeManifest.version, "1.9.0");
...
test("Firefox excludes unsupported Chrome APIs and declares AMO metadata", () => {
  ...
  assert.ok(firefoxManifest.background.scripts.includes("src/tech.js"));
  assert.ok(firefoxManifest.background.scripts.includes("src/score.js"));
...
test("Safari excludes unsupported Chrome APIs and loads its adapter", () => {
  ...
  assert.ok(safariManifest.background.scripts.includes("src/tech.js"));
  assert.ok(safariManifest.background.scripts.includes("src/score.js"));
});
