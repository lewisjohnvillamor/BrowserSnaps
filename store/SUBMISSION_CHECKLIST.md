...
- [ ] Push BrowserSnaps v1.10.0 and confirm the public repository opens without signing in.
...
- [ ] Confirm `dist/BrowserSnaps-v1.10.0-chrome-web-store.zip` is generated.
...
- [ ] Upload `dist/BrowserSnaps-v1.10.0-chrome-web-store.zip`.
- [ ] Confirm the dashboard reads version 1.10.0.
